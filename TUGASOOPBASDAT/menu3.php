...
FROM
    tumbuhan t
INNER JOIN penyakit p ON p.id = t.id
INNER JOIN obat o ON o.id = t.id
ORDER BY
	t.id");
...
<header>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="menu3.php" style="background-color:black; color:white;">menu3</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- Navbar -->
    ...
    <div class="container">
    <h1>Daftar Reka Medis Tumbuhan</h1>
                    <table class="table">
    ...
    <ul class="pagination">
    <li class="page-item"><a class="page-link" href="menu2.php" style="background:blue; color:white;">Previous</a></li>
  </ul>
</nav>
    </div>
